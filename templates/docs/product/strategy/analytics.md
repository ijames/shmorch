...
Record final tool decision in [decisions/](../decisions/index.md) before writing instrumentation code.
...
2. Define event schema in `technology/architecture/`
3. Event emitter utility — thin wrapper with swappable sink
4. Tool decision → [decisions/](../decisions/index.md)
