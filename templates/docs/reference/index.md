...
Lookup-only material. No design or development reasoning lives here — this is where
facts, examples, logs, and instructions go once they're stable. Flat topic folders, no
categorical wrapper layer.
...
| [scoring-rubric.md](scoring-rubric.md) | Scoring criteria and dimension definitions |
-->
