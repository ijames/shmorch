...
SESSION
  ...
  /shmorch reorient [focus|readiness]
                             Adaptive, tree-gated interview: project focus/shape and SRE-style
                             production readiness (monitoring, security, backups, cost, on-call).
                             Re-runnable any time, unlike orient's fixed one-time questions.
