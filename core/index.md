...
| `web_spec_compliance.md` | Web spec compliance — SEO, GEO/agent-readiness, accessibility, security, performance, privacy, resilience, i18n; audited live via the `specification.website` MCP |
