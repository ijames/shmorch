...
status: Active
updated: 2026-07-30
summary: Self-improve 2026-07-30 — 9 proposals, 9 applied as PRs #75-#84 (docs/inbox restructure, ux.md system-preference defaults, wrap recap files-touched, plan/ directory registry, pnpm precedent, init settings.json explanation, richer build.md DoD language, adversarial verification pass, CW-8 escalation fix, NOTES.md cleanup). All unmerged — VERSION 20260730.02 collides across them, needs sequencing at merge time.
---

# Session Log

## Latest Session — 2026-07-30 — Self-improve batch
