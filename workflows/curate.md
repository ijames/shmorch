...
3. Promote findings:
   ...
   - Bugs or tasks not in plan → `docs/project/plan.md` Known Bugs or Backlog
   - Nothing new → skip
...
5. Flag all gaps — add to `docs/project/plan.md` as quick fixes, don't silently skip
...
3. Flag untested new public methods in `docs/project/plan.md`

---

## Output
- `docs/{product,technology}/decisions/ (topic-appropriate)` — updated with any promoted Zulip findings
- `docs/project/plan.md` — updated with doc/test gaps flagged as quick fixes
